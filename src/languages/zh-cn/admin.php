 ...
 * @version $Id: admin.php 738 2013-08-13 01:18:22Z 85825770@qq.com $
 */
//index
...
$LANG['main_safety_permissions'] = '※ 强烈建议您将src目录设置为644（linux/unix）或只读（NT）';
...
$LANG['model_clas_no_exist'] = '_model.php文件不存在，请先将该文件上传至数据模型目录！';
...
$LANG['update_feedback_model'] = '更新留言反馈模型';
...
$LANG['create_to_rootdir_tips'] = '当设置了 config/system.php 中的 html_root 时，将生成到该目录';
