...
<tr>
						...
						<td width="20%"><img
							src="<?php echo file_icon($info['filename'],'gif')?>" /> <?php echo $info['filename']?> <?php echo $thumb ? '<img title="'.L('att_thumb_manage').'" src="statics/images/admin_img/havthumb.png" onclick="showthumb('.$info['aid'].', \''.String::addslashes($info['filename']).'\')"/>':''?> <?php echo $info['status'] ? '<img src="statics/images/admin_img/link.png"':''?></td>
						...
						<td align="center"><a
							href="javascript:preview(<?php echo $info['aid']?>, '<?php echo $info['filename']?>','<?php echo $info['filepath']?>')"><?php echo L('preview')?></a>
							| <a href="javascript:;"
...
function showthumb(id, name) {
	window.top.art.dialog.open('?app=attachment&controller=manage&action=pullic_showthumbs&aid='+id ,{
