 ...
 * @version $Id: ManageController.php 623 2013-07-29 03:40:03Z 85825770@qq.com $
 */
defined ( 'IN_YUNCMS' ) or exit ( 'No permission resources.' );

error_reporting ( E_ERROR );
class ManageController extends Web_Admin {
	...
	public function init() {
		...
		$pages = $this->db->pages;
		include $this->view ( 'attachment_list' );
	}
	...
	public function dir() {
		...
		include $this->view ( 'attachment_dir' );
	}
	...
	public function pullic_showthumbs() {
		...
		$show_header = 1;
		include $this->view ( 'attachment_thumb' );
	}
