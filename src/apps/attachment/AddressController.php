 ...
 * @version $Id: AddressController.php 623 2013-07-29 03:40:03Z 85825770@qq.com $
 */
defined ( 'IN_YUNCMS' ) or exit ( 'No permission resources.' );

class AddressController extends Web_Admin {
	...
	public function update() {
		...
		foreach ( $r as $k => $v ) {
			...
			// 获取每个表的数据表结构
			if (! file_exists ( WEKIT_PATH . 'model' . DIRECTORY_SEPARATOR . $table_name . '_model' . '.php' )) {
				$modle_table_db = $db;
			} else {
