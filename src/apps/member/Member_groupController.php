 ...
 * $Id: Member_groupController.php 677 2013-07-30 03:43:44Z 85825770@qq.com $
 */
class Member_groupController extends Web_Admin {
    ...
    function init() {
        ...
        include $this->view ( 'member_group_list' );
    }
    ...
    function add() {
        if (isset ( $_POST ['dosubmit'] )) {
            ...
            include $this->view ( 'member_group_add' );
        }
    ...
    function edit() {
        if (isset ( $_POST ['dosubmit'] )) {
            ...
            include $this->view ( 'member_group_edit' );
        }
    }
    ...
    function delete() {
        ...
        if ($this->db->where(array('groupid'=>array('in',$groupids)))->delete ()) {
            $this->_updatecache ();
            showmessage ( L ( 'operation_success' ), HTTP_REFERER );
        } else {
            showmessage ( L ( 'operation_failure' ), HTTP_REFERER );
