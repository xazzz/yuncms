...
class Member_modelfieldController extends Web_Admin {
	...
	public function manage() {
		...
		$modelinfo = $this->model_db->getby_modelid ( $modelid );
		...
		include $this->view ( 'member_modelfield_list' );
	}
	...
	public function add() {
		if (isset ( $_POST ['dosubmit'] )) {
			...
			include $this->view ( 'member_modelfield_add' );
		}
	}
	...
	public function edit() {
		if (isset ( $_POST ['dosubmit'] )) {
			...
			header ( "Cache-control: private" );
			include $this->view ( 'member_modelfield_edit' );
		}
	}
