 ...
 * @version $Id: IndexController.php 631 2013-07-29 06:47:30Z 85825770@qq.com $
 */
...
class IndexController {
    ...
    protected function _show_result($status = 0, $msg = '',$data,$total) {
        ...
        exit(trim_script($_GET['callback']).'('.json_encode(array('status'=>$status,'data'=>$data,'total'=>$total, 'msg'=>$msg)).')');
    }
}