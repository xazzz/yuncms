 ...
 * @version $Id: FileController.php 623 2013-07-29 03:40:03Z 85825770@qq.com $
 */
defined ( 'IN_YUNCMS' ) or exit ( 'No permission resources.' );

error_reporting ( E_ERROR );
class FileController extends Web_Admin {
	...
	public function init() {
		...
		$local = str_replace ( array (WEKIT_PATH,DIRECTORY_SEPARATOR . DIRECTORY_SEPARATOR ), array ('',DIRECTORY_SEPARATOR ), $filepath );
		if (substr ( $local, - 1, 1 ) == '.') {
	...
	public function add_file() {
		...
		include $this->view ( 'file_add_file' );
	}
