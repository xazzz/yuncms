 ...
 * @version $Id: Template_bakController.php 623 2013-07-29 03:40:03Z 85825770@qq.com $
 */
defined ( 'IN_YUNCMS' ) or exit ( 'No permission resources.' );

class Template_bakController extends Web_Admin {
	...
	public function init() {
		...
		$pages = $this->db->pages;
		$show_header = true;
		include $this->view ( 'template_bak_list' );
	}
