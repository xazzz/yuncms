 ...
 * @version $Id: StyleController.php 623 2013-07-29 03:40:03Z 85825770@qq.com $
 */
defined ( 'IN_YUNCMS' ) or exit ( 'No permission resources.' );

class StyleController extends Web_Admin {
	// 模板文件夹
	private $filepath;
	...
	public function set_default() {
		...
		Base_Config::modify ( 'template', array ('name' => $style ) ); // 模板配置
	...
	public function import() {
		if (isset ( $_POST ['dosubmit'] )) {
			...
			$show_header = true;
			include $this->view ( 'style_import' );
		}
	}
