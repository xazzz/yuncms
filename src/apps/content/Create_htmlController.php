 ...
 * @version $Id: Create_htmlController.php 671 2013-07-30 03:29:41Z 85825770@qq.com $
 */
defined ( 'IN_YUNCMS' ) or exit ( 'No permission resources.' );

error_reporting ( E_ERROR );
class Create_htmlController extends Web_Admin {
	...
	public function category() {
		if (isset ( $_POST ['dosubmit'] )) {
			...
			$tree->init ( $categorys );
			$string .= $tree->get_tree ( 0, $str );
			include $this->view ( 'create_html_category' );
		}
