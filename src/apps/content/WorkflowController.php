 ...
 * @version $Id: WorkflowController.php 633 2013-07-29 07:17:38Z 85825770@qq.com $
 */
defined ( 'IN_YUNCMS' ) or exit ( 'No permission resources.' );

class WorkflowController extends Web_Admin {
	...
	public function init() {
		...
		$this->_cache ();
		include $this->view ( 'workflow_list' );
	}
	...
	public function add() {
		if (isset ( $_POST ['dosubmit'] )) {
			...
			include $this->view ( 'workflow_add' );
		}
	}
	...
	public function edit() {
		if (isset ( $_POST ['dosubmit'] )) {
			...
			include $this->view ( 'workflow_edit' );
		}
	}
	...
	public function show() {
		...
		include $this->view ( 'workflow_view' );
	}
