 ...
 * $Id: Model_fieldController.php 675 2013-07-30 03:40:40Z 85825770@qq.com $
 */
...
class Model_fieldController extends Web_Admin {
	...
	public function init() {
		...
		include $this->view ( 'model_field_manage' );
	}
	...
	public function add() {
		if (isset ( $_POST ['dosubmit'] )) {
			...
			include $this->view ( 'model_field_add' );
		}
	}
	...
	public function edit() {
		if (isset ( $_POST ['dosubmit'] )) {
			...
			header ( "Cache-control: private" );
			include $this->view ( 'model_field_edit' );
		}
	}
