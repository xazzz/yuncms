 ...
 * @version $Id: special_api.php 667 2013-07-30 03:08:40Z 85825770@qq.com $
 */
class special_api {
	...
	public function _del_special($id = 0) {
		...
		if ($info ['ishtml']) {
			Folder::rm ( BASE_PATH . C ( 'system', 'html_root' ) . DIRECTORY_SEPARATOR . 'special' . DIRECTORY_SEPARATOR . $info ['filename'] ); // 删除专题目录
		}
