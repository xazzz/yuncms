...
class SpecialController extends Web_Admin {
	...
	public function init() {
		...
		include $this->view ( 'special_list' );
	}
	...
	public function import() {
		if (isset ( $_POST ['dosubmit'] ) || isset ( $_GET ['dosubmit'] )) {
			...
			include $this->view ( 'import_content' );
		}
	}
