...
if(is_array($infos)){
	...
	<tr>
		...
		<td align="center" width="12%"><a href="###" onclick="edit(<?php echo $info['linkid']?>, '<?php echo String::addslashes($info['name'])?>')" title="<?php echo L('edit')?>"><?php echo L('edit')?></a> |
			<a href="<?php echo art_confirm(L('confirm', array('message' => String::addslashes($info['name']))), '?app=link&controller=link&action=delete&linkid='.$info['linkid']);?>"><?php echo L('delete')?></a>
		</td>
	</tr>
	<?php
	}
