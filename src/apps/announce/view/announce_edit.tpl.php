		...
		.functionValidator({
	    	fun:function(val,elem){
		    	if(!UE.getEditor('content').hasContents()){
		    	    return "<?php echo L('announcements_cannot_be_empty')?>"} else {return true;}}}).defaultPassed();
	$('#style')
		.formValidator({
