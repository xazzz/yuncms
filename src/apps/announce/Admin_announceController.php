 ...
 * @version $Id: Admin_announceController.php 632 2013-07-29 06:52:11Z 85825770@qq.com $
 */
defined ( 'IN_YUNCMS' ) or exit ( 'No permission resources.' );

class Admin_announceController extends Web_Admin {
	...
	public function init() {
		...
		include $this->view ( 'announce_list' );
	}
	...
	public function add() {
		if (isset ( $_POST ['dosubmit'] )) {
			...
			include $this->view ( 'announce_add' );
		}
	}
