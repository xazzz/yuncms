 ...
 */
class MessageController extends Web_Admin {
	...
	public function init() {
		...
		include $this->view ( 'message_list' );
	}
	...
	public function message_group_manage() {
		...
		$big_menu = big_menu ( '?app=message&controller=message&action=message_send', 'add', L ( 'all_send_message' ), 550, 300 );
		include $this->view ( 'message_group_list' );
	}
	...
	public function message_send() {
		if (isset ( $_POST ['dosubmit'] )) {
			...
			include $this->view ( 'message_send' );
		}
	}
	...
	public function send_one() {
		if (isset ( $_POST ['dosubmit'] )) {
			...
			$big_menu = big_menu ( '?app=message&controller=message&action=message_send', 'add', L ( 'all_send_message' ), 550, 300 );
			include $this->view ( 'message_send_one' );
		}
	}
	...
	public function my_inbox() {
		...
		$big_menu = big_menu ( '?app=message&controller=message&action=message_send', 'add', L ( 'all_send_message' ), 550, 300 );
		$trade_status = $this->trade_status;
		include $this->view ( 'message_inbox_list' );
	}
	...
	public function my_outbox() {
		...
		$big_menu = big_menu ( '?app=message&controller=message&action=message_send', 'add', L ( 'all_send_message' ), 550, 300 );
		$trade_status = $this->trade_status;
		include $this->view ( 'message_outbox_list' );
	}
	...
	public function search_message() {
		...
		$big_menu = big_menu ( '?app=message&controller=message&action=message_send', 'add', L ( 'all_send_message' ), 550, 300 );
		$trade_status = $this->trade_status;
		include $this->view ( 'message_search_list' );
	}
}
?>