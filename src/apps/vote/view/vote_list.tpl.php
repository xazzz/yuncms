...
if(is_array($infos)){
	...
	<tr>
		...
		<td align="center"><a href='###'
			onclick="statistics(<?php echo $info['subjectid']?>, '<?php echo String::addslashes($info['subject'])?>')"> <?php echo L('statistics')?></a>
		| <a href="###"
			onclick="edit(<?php echo $info['subjectid']?>, '<?php echo String::addslashes($info['subject'])?>')"
			title="<?php echo L('edit')?>"><?php echo L('edit')?></a> | <a href="javascript:call(<?php echo String::addslashes($info['subjectid'])?>);void(0);"><?php echo L('call_js_code')?></a> | <a
			href='?app=vote&controller=vote&action=delete&subjectid=<?php echo String::addslashes($info['subjectid'])?>'
