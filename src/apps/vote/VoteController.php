 ...
 * @version $Id: VoteController.php 647 2013-07-29 09:10:17Z 85825770@qq.com $
 */
defined ( 'IN_YUNCMS' ) or exit ( 'No permission resources.' );

error_reporting ( E_ERROR );
class VoteController extends Web_Admin {
	private $db2, $db;
	...
	public function statistics() {
		...
		include $this->view ( 'vote_statistics' );
	}
	...
	public function statistics_userlist() {
		...
		$pages = $sdb->pages;
		include $this->view ( 'vote_statistics_userlist' );
	}
	...
	public function public_get_votelist() {
		...
		include $this->view ( 'get_votelist' );
	}
