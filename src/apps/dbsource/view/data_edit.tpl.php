...
<fieldset>
    ...
    <td class="y-bg"><?php echo Form::radio(array('0'=>L('model_configuration'), '1'=>L('custom_sql')), isset($type) ? $type : 0, 'name="type" onclick="location.href=\''.Base_Request::get_url().'&type=\'+this.value"')?></td>
  </tr>
  <?php if ($type==0) :?>
    <tr>
