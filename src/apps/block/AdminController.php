 ...
 * @version $Id: AdminController.php 658 2013-07-30 02:02:20Z 85825770@qq.com $
 */
defined ( 'IN_YUNCMS' ) or exit ( 'No permission resources.' );

class AdminController extends Web_Admin {
	...
	public function add() {
		...
		if (isset ( $_POST ['dosubmit'] )) {
			...
			include $this->view ( 'block_add_edit' );
		}
	}
	...
	public function block_update() {
		...
		if (isset ( $_POST ['dosubmit'] )) {
			...
			include $this->view ( 'block_update' );
		}
	}
	...
	public function public_view() {
		...
		if ($data ['type'] == 1) {
			...
			$str = $tpl->template_parse ( String::stripslashes ( $template ) );
	...
	public function public_search_content() {
		...
		$show_header = $show_validator = $show_dialog = true;
		include $this->view ( 'search_content' );
	}
