...
<div class="subnav">
    ...
    <?php echo Web_Admin::submenu($_GET['menuid'],$big_menu); ?><span>|</span><a href="<?php $b = big_menu('index.php?app=formguide&controller=formguide&action=setting', 'setting', L('module_setting'), 550, 350);echo $b[0]?>"><em><?php echo L('module_setting')?></em></a>
    </div>
</div>
<div class="pad-lr-10">
