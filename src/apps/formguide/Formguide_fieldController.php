...
class Formguide_fieldController extends Web_Admin {
	...
	public function init() {
		...
		include $this->view ( 'formguide_field_list' );
	}
	...
	public function add() {
		if (isset ( $_POST ['dosubmit'] )) {
			...
			include $this->view ( 'formguide_field_add' );
		}
	}
	public function edit() {
		if (isset ( $_POST ['dosubmit'] )) {
			...
			header ( "Cache-control: private" );
			include $this->view ( 'formguide_field_edit' );
		}
	}
