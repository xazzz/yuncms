...
class FormguideController extends Web_Admin {
	...
	public function init() {
		...
		include $this->view ( 'formguide_list' );
	}
	...
	public function add() {
		if (isset ( $_POST ['dosubmit'] )) {
			...
			include $this->view ( 'formguide_add' );
		}
	}
	...
	public function public_preview() {
		...
		$show_header = 1;
		include $this->view ( 'formguide_preview' );
	}
	...
	public function stat() {
		...
		$datas = $m_db->select ();
		$total = count ( $datas );
		include $this->view ( 'formguide_stat' );
	}
