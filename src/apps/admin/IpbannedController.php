 ...
 * @version $Id: IpbannedController.php 623 2013-07-29 03:40:03Z 85825770@qq.com $
 */
defined ( 'IN_YUNCMS' ) or exit ( 'No permission resources.' );

class IpbannedController extends Web_Admin {
	...
	public function init() {
		...
		include $this->view ( 'ipbanned_list' );
	}
	...
	public function add() {
		if (isset ( $_POST ['dosubmit'] )) {
			...
			include $this->view ( 'ipbanned_add' );
		}
	}
	...
	public function search_ip() {
		...
		$pages = $this->db->pages;
		$big_menu = big_menu ( U ( 'admin/ipbanned/add' ), 'add', L ( 'add_ipbanned' ), 450, 300 );
		include $this->view ( 'ip_search_list' );
	}
