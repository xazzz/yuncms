 ...
 * @version $Id: cache_api.php 628 2013-07-29 06:12:08Z 85825770@qq.com $
 */
class cache_api {
	...
	public function cache($model = '', $param = '') {
		if (file_exists ( WEKIT_PATH . 'model' . DIRECTORY_SEPARATOR . $model . '_model.php' )) {
	...
	public function database() {
		...
		$filepath = WEKIT_PATH . 'config' . DIRECTORY_SEPARATOR;
