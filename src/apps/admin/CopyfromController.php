 ...
 * @version $Id: CopyfromController.php 636 2013-07-29 07:37:31Z 85825770@qq.com $
 */
defined ( 'IN_YUNCMS' ) or exit ( 'No permission resources.' );

class CopyfromController extends Web_Admin {
	private $db;
	...
	public function init() {
		...
		$this->public_cache ();
		include $this->view ( 'copyfrom_list' );
	}
	...
	public function add() {
		if (isset ( $_POST ['dosubmit'] )) {
			...
			include $this->view ( 'copyfrom_add' );
		}
	}
	...
	public function edit() {
		if (isset ( $_POST ['dosubmit'] )) {
			...
			extract ( $r );
			include $this->view ( 'copyfrom_edit' );
		}
	}
