 ...
 * @version $Id: LinkageController.php 674 2013-07-30 03:34:46Z 85825770@qq.com $
 */
class LinkageController extends Web_Admin {
	private $db;
	...
	public function init() {
		...
		include $this->view ( 'linkage_list' );
	}
	...
	public function edit() {
		if (isset ( $_POST ['dosubmit'] )) {
			...
			$show_header = true;
			$show_validator = true;
			include $this->view ( 'linkage_edit' );
		}
	...
	public function public_get_list() {
		$where = array ('keyid' => 0 );
		$infos = $this->db->where($where)->select (  );
		include $this->view ( 'linkage_get_list' );
	}
