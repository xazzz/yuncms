	...
	?>
        <tr>
          ...
          <td align="center"><?php if($r['thumb']) {?>
            ...
            <?php }?></td>
          <td align="center"><a
							href="javascript:edit('<?php echo $r['id']?>','<?php echo String::addslashes($r['sitename'])?>')"><?php echo L('edit');?></a> | <a href="javascript:;"
							onclick="data_delete(this,'<?php echo $r['id']?>','<?php echo L('confirm',array('message'=>String::addslashes($r['sitename'])));?>')"><?php echo L('delete')?></a></td>
        </tr>
        <?php } ?>
      </tbody>
    </table>
