 ...
 * @version $Id: Cache_allController.php 628 2013-07-29 06:12:08Z 85825770@qq.com $
 */
defined ( 'IN_YUNCMS' ) or exit ( 'No permission resources.' );

class Cache_allController extends Web_Admin {
	private $cache_api;
	...
	public function init() {
		if (isset ( $_POST ['dosubmit'] ) || isset ( $_GET ['dosubmit'] )) {
			...
			$apps = array (
					...
					array('name' => L('update_feedback_model'), 'mod' =>'feedback', 'file' => 'feedback', 'function' =>'public_cache'),
