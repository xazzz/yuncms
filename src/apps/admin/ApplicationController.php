 ...
 * @version $Id: ApplicationController.php 623 2013-07-29 03:40:03Z 85825770@qq.com $
 */

class ApplicationController extends Web_Admin {
	private $db;
	...
	public function install() {
		...
		if (isset ( $_POST ['dosubmit'] )) {
			...
			include $this->view ( 'application_config' );
		}
	}
