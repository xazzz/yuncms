 ...
 * @version $Id: PositionController.php 639 2013-07-29 07:39:39Z 85825770@qq.com $
 */
defined ( 'IN_YUNCMS' ) or exit ( 'No permission resources.' );

class PositionController extends Web_Admin {
	...
	public function init() {
		...
		include $this->view ( 'position_list' );
	}
	...
	public function add() {
		if (isset ( $_POST ['dosubmit'] )) {
			...
			include $this->view ( 'position_add' );
		}
	...
	public function edit() {
		if (isset ( $_POST ['dosubmit'] )) {
			...
			include $this->view ( 'position_edit' );
		}
	}
	...
	public function public_item() {
		if (isset ( $_POST ['dosubmit'] )) {
			...
			include $this->view ( 'position_items' );
		}
	}
	...
	public function public_item_manage() {
		if (isset ( $_POST ['dosubmit'] )) {
			...
			$show_validator = true;
			$show_header = true;
			include $this->view ( 'position_item_manage' );
		}
	}
