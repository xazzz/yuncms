 ...
 * @version $Id: BadwordController.php 623 2013-07-29 03:40:03Z 85825770@qq.com $
 */
defined ( 'IN_YUNCMS' ) or exit ( 'No permission resources.' );

class BadwordController extends Web_Admin {
	...
	public function init() {
		...
		include $this->view ( 'badword_list' );
	}
	...
	public function edit() {
		if (isset ( $_POST ['dosubmit'] )) {
			...
			extract ( $info );
			include $this->view ( 'badword_edit' );
		}
	}
	...
	public function import() {
		if (isset ( $_POST ['dosubmit'] )) {
			...
			include $this->view ( 'badword_import' );
		}
	}
