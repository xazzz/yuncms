 ...
 * @version $Id: UrlruleController.php 623 2013-07-29 03:40:03Z 85825770@qq.com $
 */
defined ( 'IN_YUNCMS' ) or exit ( 'No permission resources.' );

class UrlruleController extends Web_Admin {
	...
	public function init() {
		...
		$this->_cache ();
		include $this->view ( 'urlrule_list' );
	}
	...
	function edit() {
		if (isset ( $_POST ['dosubmit'] )) {
			...
			include $this->view ( 'urlrule_edit' );
		}
	}
