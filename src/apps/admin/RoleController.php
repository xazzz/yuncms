 ...
 * @version $Id: RoleController.php 623 2013-07-29 03:40:03Z 85825770@qq.com $
 */
defined ( 'IN_YUNCMS' ) or exit ( 'No permission resources.' );

error_reporting ( E_ERROR );
class RoleController extends Web_Admin {
	...
	public function setting_cat_priv() {
		...
		switch ($op) {
			...
			default :
				...
				include $this->view ( 'role_cat_priv' );
				break;
		}
	}
