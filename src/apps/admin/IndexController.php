 ...
 * @version $Id: IndexController.php 700 2013-07-31 02:31:18Z 85825770@qq.com $
 */
defined ( 'IN_YUNCMS' ) or exit ( 'No permission resources.' );

class IndexController extends Web_Admin {
	...
	public function public_current_pos() {
		echo Web_Admin::current_pos ( $_GET ['menuid'] );
		exit ();
	}
	...
	*/
	...
	public function public_menu_left() {
		...
		$datas = Web_Admin::admin_menu ( $menuid );
	...
	public function public_map() {
		$array = Web_Admin::admin_menu ( 0 );
		$menu = array ();
		foreach ( $array as $k => $v ) {
			$menu [$v ['id']] = $v;
			$menu [$v ['id']] ['childmenus'] = Web_Admin::admin_menu ( $v ['id'] );
		}
		$show_header = true;
		include $this->view ( 'map' );
	}
