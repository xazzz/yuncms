 ...
 * @version $Id: DatabaseController.php 623 2013-07-29 03:40:03Z 85825770@qq.com $
 */
defined ( 'IN_YUNCMS' ) or exit ( 'No permission resources.' );
@set_time_limit ( 0 );

class DatabaseController extends Web_Admin {
	...
	public function export() {
		...
		if (isset ( $_POST ['dosubmit'] ) || isset ( $_GET ['dosubmit'] )) {
			...
			$this->db = Factory::db ( $this->pdo_name );
	...
	public function import() {
		...
		if (isset ( $_GET ['dosubmit'] )) {
			...
			$show_validator = true;
			include $this->view ( 'database_import' );
		}
	}
