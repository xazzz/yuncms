...
(function () {
    ...
    scrawl.prototype = {
        ...
        originalState:function (options) {
            ...
            $G("fileForm").action = url + (url.indexOf("?") == -1 ? "?" : "&") + "&act=tmpImg" + "&swf_auth_key=" +editor.options.swf_auth_key + "&SWFUPLOADSESSID=" +editor.options.SWFUPLOADSESSID + "&isadmin=" +editor.options.isadmin + "&userid=" +editor.options.userid + "&groupid=" +editor.options.groupid;//初始form提交地址
