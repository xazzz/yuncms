 ...
 * @version $Id: Admin.php 641 2013-07-29 08:56:12Z 85825770@qq.com $
 */
class Web_Admin extends Web_Controller {
	public $userid;
	public $username;
	...
	public function __construct() {
		...
		//if (! app_exists ( APP )) showmessage ( L ( 'application_not_exists' ) );
		self::manage_log ();
		self::check_ip ();
		self::lock_screen ();
	 ...
	 */
	final public static function view($file, $application = '') {
