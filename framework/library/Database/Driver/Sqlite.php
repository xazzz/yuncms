 ...
 * @version $Id: Sqlite.php 623 2013-07-29 03:40:03Z 85825770@qq.com $
 */
class Database_Driver_Sqlite extends Base_DB {
	...
	public function __construct($config = '') {
		if (! extension_loaded ( 'sqlite' )) {
			throw new Base_Exception ( 'suppert does not exist.' . ':sqlite' );
		}
		if (! empty ( $config )) {
			$this->config = $config;
		}
