 ...
 * @version $Id: Request.php 682 2013-07-30 03:48:55Z 85825770@qq.com $
 */
class Base_Request {
	...
	public function get_user_browser() {
		$user_agent_info = self::get_server('HTTP_USER_AGENT');
	...
	public static function is_ie() {
		return strpos ( self::get_server( 'HTTP_USER_AGENT' ), 'MSIE' ) ? true : false;
	}
