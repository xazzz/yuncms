...
class Base_Config {
	...
	public static function modify($file, $data = array()) {
		...
		$str = File::read ( self::$_file );
		$str = preg_replace ( $pattern, $replacement, $str );
		return File::write(self::$_file, $str);
	}
